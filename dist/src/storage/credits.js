...
export class CreditLedger {
    ...
    taskTokens(taskId) { return this.tokenTotals('p.task_id=?', taskId); }
    sessionTokens(sessionId) { return this.tokenTotals('COALESCE(t.session_id,p.owner_instance)=?', sessionId); }
