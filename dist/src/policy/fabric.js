...
const cap = (value, ceiling, allowZero = false) => typeof value === 'number' && (value > 0 || (allowZero && value === 0)) ? Math.min(value, ceiling) : ceiling;
...
export function fabricGuardStatus(dir = agentDir()) {
