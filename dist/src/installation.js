...
export function installationIdPath(config) {
    return path.join(config.stateDir, FILE_NAME);
}
function readId(config, secure = false) {
...
export function installationStatus(config) {
...
export function ensureInstallationId(config) {
